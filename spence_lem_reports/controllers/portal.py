...
class CustomerPortal(CustomerPortal):
    ...
    def portal_lem_sign(self, lem_id, access_token=None, source=False, name=None, signature=None):
        ...
        if lem_sudo.sale_order_id.use_costed_report:
            ...
            filename = f"Costed LEM{' - ' + lem_sudo.sale_order_id.name if lem_sudo.sale_order_id else ''} - {lem_sudo.name} - {lem_sudo.date_performed.strftime('%d-%m-%Y')} - {lem_sudo.id}.pdf"
        ...
        filename = f"LEM{' - ' + lem_sudo.sale_order_id.name if lem_sudo.sale_order_id else ''} - {lem_sudo.name} - {lem_sudo.date_performed.strftime('%d-%m-%Y')} - {lem_sudo.id}.pdf"
